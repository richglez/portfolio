...
const TECHS: { name: string; icon: string }[] = [
  ...
  { name: "pnpm", icon: "pnpm/pnpm-original-wordmark" },
  { name: "yarn", icon: "yarn/yarn-original" },
  ...
  { name: "JSON", icon: "json/json-plain" },
  { name: "Insomnia", icon: "insomnia/insomnia-plain" },
  { name: "Postman", icon: "postman/postman-plain" },
  { name: "xml", icon: "xml/xml-plain" },
  { name: "CSS", icon: "css3/css3-plain" },
  { name: "HTML", icon: "html5/html5-plain" },
